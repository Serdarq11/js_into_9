...
// toFixed() - rounding the number decimal side for up to given argument (the number passed in the parantheses of the method)
...
// converting other data values into numbers -> Number(), parseInt(), parseFloat()
let num1 = '10';
let num2 = '10.5';
...
console.log(Number.isInteger(1234.2783848)); // false 
