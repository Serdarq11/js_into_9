...
console.log(company.charAt(-1));    // ''  -> empty string
console.log(company.charAt(10));    // ''  -> empty string
...
// 2 ways to solve
console.log(word[0] + word[word.length - 1]);   // Ho
console.log(word.charAt(0) + word.charAt(word.length - 1));   // Ho
