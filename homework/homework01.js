...
let average2 = (a1 + a2 + a3 + a4 + a5) / 5;

console.log('The average of the numbers is: ' + average2);
...
console.log('The 5 multiplied by 5 is = ' + (b1 * b1));
console.log('The 6 multiplied by 6 is = ' + (b2 * b2));
console.log('The 10 multiplied by 10 is = ' + (b3 * b3));
